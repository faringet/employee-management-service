...
func MakeGetTemplQuestionaryTagsByIDHandler(s templateservice.Service, logger *zap.Logger) http.Handler {
	...
	h := kithttp.NewServer(
		endpoints.MakeGetTemplQuestionaryTagsByIDEndpoint(s),
		getTemplQuestionaryTagsByIDDecodeRequest,
		encodeResponse,
		opts...,
	)
...
func getTemplQuestionaryTagsByIDDecodeRequest(_ context.Context, r *http.Request) (interface{}, error) {
	vars := mux.Vars(r)
	idStr, ok := vars["id"]
...
func MakeGetTemplQuestionaryTagsHandler(s templateservice.Service, logger *zap.Logger) http.Handler {
	opts := []kithttp.ServerOption{
		kithttp.ServerFinalizer(finalyzer),
		kithttp.ServerErrorEncoder(encodeError),
	}
	...
	h := kithttp.NewServer(
		endpoints.MakeGetTemplQuestionaryTagsEndpoint(s),
		getTemplQuestionaryTagsDecodeRequest,
		encodeResponse,
		opts...,
	)
...
func getTemplQuestionaryTagsDecodeRequest(_ context.Context, r *http.Request) (interface{}, error) {
	...
	var req endpoints.GetTemplQuestionaryTagsRequest
...
func MakeCreateTemplQuestionaryTagsHandler(s templateservice.Service, logger *zap.Logger) http.Handler {
	opts := []kithttp.ServerOption{
		kithttp.ServerFinalizer(finalyzer),
		kithttp.ServerErrorEncoder(encodeError),
	}
	...
	h := kithttp.NewServer(
		endpoints.MakeCreateTemplQuestionaryTagsEndpoint(s),
		createTemplQuestionaryTagsDecodeRequest,
		encodeResponse,
		opts...,
	)
...
func createTemplQuestionaryTagsDecodeRequest(ctx context.Context, r *http.Request) (interface{}, error) {
	email, err := getEmail(ctx)
	if err != nil {
		return nil, err
	}

	var req endpoints.CreateTemplQuestionaryTagsRequest
...
func MakeCreateTemplQuestionaryTagsRangeHandler(s templateservice.Service, logger *zap.Logger) http.Handler {
	opts := []kithttp.ServerOption{
		kithttp.ServerFinalizer(finalyzer),
		kithttp.ServerErrorEncoder(encodeError),
	}
	...
	h := kithttp.NewServer(
		endpoints.MakeCreateTemplQuestionaryTagsRangeEndpoint(s),
		createTemplQuestionaryTagsRangeDecodeRequest,
		encodeResponse,
		opts...,
	)
...
func createTemplQuestionaryTagsRangeDecodeRequest(ctx context.Context, r *http.Request) (interface{}, error) {
	email, err := getEmail(ctx)
	if err != nil {
		return nil, err
	}

	var req endpoints.CreateTemplQuestionaryTagsRangeRequest
	req.CreatorEmail = email
...
func MakeDeleteTemplQuestionaryTagsByIDHandler(s templateservice.Service, logger *zap.Logger) http.Handler {
	opts := []kithttp.ServerOption{
		kithttp.ServerFinalizer(finalyzer),
		kithttp.ServerErrorEncoder(encodeError),
	}
	...
	h := kithttp.NewServer(
		endpoints.MakeDeleteTemplQuestionaryTagsByIDEndpoint(s),
		deleteTemplQuestionaryTagsDecodeRequest,
		encodeResponse,
		opts...,
	)
...
func deleteTemplQuestionaryTagsDecodeRequest(ctx context.Context, r *http.Request) (interface{}, error) {
	vars := mux.Vars(r)
	idStr, ok := vars["id"]
...
func MakeUpdateTemplQuestionaryTagsByIDHandler(s templateservice.Service, logger *zap.Logger) http.Handler {
	opts := []kithttp.ServerOption{
		kithttp.ServerFinalizer(finalyzer),
		kithttp.ServerErrorEncoder(encodeError),
	}
	...
	h := kithttp.NewServer(
		endpoints.MakeUpdateTemplQuestionaryTagsEndpoint(s),
		updateTemplQuestionaryTagsTemplateByIDDecodeRequest,
		encodeResponse,
		opts...,
	)
...
func updateTemplQuestionaryTagsTemplateByIDDecodeRequest(ctx context.Context, r *http.Request) (interface{}, error) {
	email, err := getEmail(ctx)
	if err != nil {
		return nil, err
	}
	...
	var req endpoints.UpdateTemplQuestionaryTagsRequest
	req.ID = int32(id)
